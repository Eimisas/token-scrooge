...
echo "    1. Start the scrooge daemon for SLM memory reconciliation:"
echo "       ${BOLD}scrooge daemon start${NC}"
echo ""
echo "  Commands:"
echo "    scrooge daemon start|status   manage memory assistant"
